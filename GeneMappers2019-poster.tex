...
\toprule
Posterior probability &$93.36\% \pm 4.69\%$ \\
Votes for correct demography & $96.33\% \pm 2.68\%$\\
...
\includegraphics[scale=.6]{pics/abc-ibd-1.png}
\end{minipage}
\end{adjustbox}
%{\small
%
...
%%% BLOCK 5
 \block[titleoffsety=3.5cm,bodyoffsety=3.5cm]{5. Acknowledgements, references and further information}{
 }
  \begin{columns}
 \begin{subcolumns}
