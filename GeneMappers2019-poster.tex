...
{\fontsize{34}{35}\selectfont Genetic sequence data is BIG and REPETITIVE:}\\[2mm]
...
\toprule
Mode & True value & Our 95\% HPDI & 95\% HPDI in [2] \\
\midrule
...
%%% BLOCK 5
 \block[titleoffsety=1cm,bodyoffsety=1cm]{5. Acknowledgements, references and further information}{
  ...
  \begin{columns}
 \begin{subcolumns}
    \subcolumn{25} \block[bodyoffsetx=1.5cm,bodyverticalshift=-5cm]{}{\footnotesize
